(module
 ...
 (func $_main (; 22 ;) (result i32)
  ...
  ;;@ ./if_tests/then_single.c:5:0
  (set_local $$1
   (i32.const 5)
  )
  ;;@ ./if_tests/then_single.c:7:0
  (set_local $$2
   (get_local $$1)
  )
  (set_local $$3
