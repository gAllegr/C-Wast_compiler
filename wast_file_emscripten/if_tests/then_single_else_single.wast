(module
 ...
 (func $_main (; 22 ;) (result i32)
  ...
  ;;@ ./if_tests/then_single_else_single.c:5:0
  (set_local $$1
   (i32.const 5)
  )
  ;;@ ./if_tests/then_single_else_single.c:8:0
  (set_local $$3
   (get_local $$1)
  )
  (set_local $$4
  ...
  (if
   ...
   (block
    ...
    ;;@ ./if_tests/then_single_else_single.c:11:0
    (return
     (i32.const 0)
    )
   )
   (block
    ;;@ ./if_tests/then_single_else_single.c:9:0
    (set_local $$2
     (i32.const 98)
    )
    (set_global $STACKTOP
