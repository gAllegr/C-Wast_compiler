(module
 ...
 (func $_main (; 22 ;) (result i32)
  ...
  ;;@ ./condition_tests/logic_conditions.c:9:0
  (set_local $$1
   (i32.const 5)
  )
  ;;@ ./condition_tests/logic_conditions.c:11:0
  (set_local $$2
   (get_local $$1)
  )
  (set_local $$3
  ...
  ;;@ ./condition_tests/logic_conditions.c:13:0
  (set_local $$7
   (get_local $$1)
  )
  (set_local $$8
  ...
  ;;@ ./condition_tests/logic_conditions.c:15:0
  (set_local $$11
   (get_local $$1)
  )
  (set_local $$12
  ...
  (if
   ...
   (block
    ...
    ;;@ ./condition_tests/logic_conditions.c:17:0
    (return
     (i32.const 0)
    )
   )
